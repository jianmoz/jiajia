...
<style scoped>
    ...
    .detail_list .detail_list_bg{ width:100%; height:100%; background: url(/static/images/movie_1.jpg) 0 40%; filter:
            blur(20px); background-size:cover; position: absolute; left: 0; top: 0;}
